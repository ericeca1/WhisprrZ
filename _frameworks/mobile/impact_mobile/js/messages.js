var CMessages = function(guid) {
    ...
    this.initGeneral = function(){
        ...
        $('body').off('mousedown touchstart').on('mousedown touchstart', '.to_one_chat .data', function(e){
        ...
        }).on('click', '.im_audio_message > .im_audio_message_loader', function(e){
			var $el=$(this);
            ...
            return false;
        }).on('click', '.message_menu_link, .message_info_module_menu, #main_wrap', function(e){
            var el=$(this);
		...
		if(!isMenuInitialized) {
			...
			$menu.position({
				...
				using: function(coords){
					...
					actionButton.addClass('initialized');
