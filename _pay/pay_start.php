...
function payment_check_return($option, $type = '', $days = '')
{
    ...
    if ($type == '') {
        ...
        if(guser('site_access_type') == 'payment') {
            $type = guser('type');

        } elseif(guser('site_access_type') == 'trial') {
            $type = guser('trial_plan_type');
        }
    }
    ...
    if((guser('site_access_type') == 'free') && guser('gold_days')) {
        return true;
    }

    // if(guser('site_access_type') == 'trial' && ($type == 0 || $type == '')) {
    //     return true;
    // }
