...
$(function(){
    ...
    var $btnActionUpgrade=$('#btn_action_upgrade').on('click',function(){
        ...
        if(typeof inAppPurchaseProducts === 'object' && !$allowPaidService.val()) {
            var item = $('#payment_items').val();
    ...
    upgradePayment = function(data){

        console.log('upgradePayment data start', data);
