...
if (in_array($cmd, ['pp_messages', 'send_message', 'uploading_msg', 'init_list_im', 'open_im_with_user', 'set_visible_open_im', 'delete_users_im', 'clear_history_messages', 'im_read_msg', 'delete_empty_im', 'set_visible_open_im', 'delete_messages', 'upload_image_im_change', 'send_request_private_access'])) {
    payment_check('im');
}
